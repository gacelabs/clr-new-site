					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item">
								<a href="https://colorlib.com/preview/theme/foode/typography.html#"><i class="fa fa-home"></i> Home</a>
							</li>
			...
			<div class="row justify-content-center">
				<div class="col-12 col-lg-10">
					<div class="type-face">
						...
						<img class="pt-5" src="assets/images/breadcrumb-line.png" alt="" />
					</div>

					<div class="foode-image">
						<h4 class="mb-30">Images</h4>
						<img class="mb-30" src="assets/images/1.webp" alt="" />
						<p>
						...
						<div class="row">
							<div class="col-12 col-md-6">
								<img class="mb-30" src="assets/images/19.jpg" alt="" />
							</div>
							<div class="col-12 col-md-6">
								<img class="mb-30" src="assets/images/20.jpg" alt="" />
							</div>
						</div>
					...
					<div class="form-button">
						...
						<div class="contact-form-area mb-50">
							<form action="https://colorlib.com/preview/theme/foode/typography.html#" method="post">
								<div class="row">
									<div class="col-12 col-md-6">
						...
						<a href="https://colorlib.com/preview/theme/foode/typography.html#" class="btn foode-btn m-2">Post Comment</a>
						<a href="https://colorlib.com/preview/theme/foode/typography.html#" class="btn foode-btn active m-2">Post Comment</a>
						<div class="d-block mb-30"></div>
						<a href="https://colorlib.com/preview/theme/foode/typography.html#" class="btn foode-btn btn-sm">Like</a>
						<a href="https://colorlib.com/preview/theme/foode/typography.html#" class="btn foode-btn btn-sm active">Reply</a>
					</div>
				</div>
			</div>
		</div>
