...
class FieldHelper{
	...
	public static function ListBox($name, $title, $list, $size = false, $value = false){
		if ($size) {
			return ListboxField::create($name, $title ?: GeneralHelper::CamelName($name), $list, $value)->setSize($size);
		} else {
